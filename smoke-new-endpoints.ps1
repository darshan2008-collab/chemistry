...
$adminLogin = Call-Api -Method 'POST' -Url "$base/auth/staff/login" -Headers @{} -Body '{"email":"unitaryx","password":"unitary@10"}'
...
$qaCreateBody = @{ subjectId = 1; staffEmail = 'smoke.staff'; title = 'Smoke QA'; message = 'Is chapter 5 test this week?' } | ConvertTo-Json
